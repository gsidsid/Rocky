...
void lyingDown()
{
  ...
  if (angleRate > -6 && angleRate < 6 && !calmer)
  {
    calmer = true;
...
void balanceDrive(int32_t leftSpeed, int32_t rightSpeed)
{
  driveLeft = leftSpeed;
